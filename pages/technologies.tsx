    ...
    <main className='flex-1 py-8 px-6'>
      ...
      <section id='about' className='mt-8'>
        ...
        <p className='text-gray-500'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed auctor, magna vitae convallis
          malesuada, velit velit faucibus ipsum, a tristique augue massa quis arcu. Sed et risus
          quis odio tempor viverra.
        </p>
      </section>
    </main>
    // </div>
