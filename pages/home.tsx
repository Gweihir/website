...
export default function HomePage(props: Props) {
  return (
    <main className='bg-slate-800 flex flex-col xl:min-h-screen_88 lg:min-h-screen_80 md:min-h-screen_70 sm:min-h-screen_40 min-h-screen_40 sm:mt-20 mt-16'>
      <Image
        width={1100}
        ...
        >
          ...
          <div className='w-full flex flex-row justify-center sm:justify-start pt-5 sm:pt-0'>
            <button
              ...
              className='px-4 py-2 mt-6 md:ml-9 font-medium cursor-pointer text-xl rounded-full text-slate-900 hover:from-secondary hover:to-accentMono active:from-secondary active:to-thirdinary bg-gradient-to-br from-primary to-accent transition duration-300'
            >
