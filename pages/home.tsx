  ...
  return (
    <main className='bg-slate-800 flex flex-col xl:min-h-screen_88 lg:min-h-screen_80 md:min-h-screen_70 sm:min-h-screen_40 min-h-screen_88 sm:mt-20 mt-16'>
      ...
      <Image
        ...
        src={epicContent}
        alt='Image'
        className='invisible lg:visible mb-4 lg:w-1/3  xl:mr-44 lg:mr-6 md:mr-48 mt-60 absolute lg:top-10 md:top-56 top-10 xl:top-0 right-0 opacity-100 animate-fade_in'
      />
